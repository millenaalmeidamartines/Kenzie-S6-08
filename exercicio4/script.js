...
function howManyEmployeesUnDepartment (departmentName) {
...
console.log(howManyEmployeesUnDepartment('Financial'));
console.log(howManyEmployeesUnDepartment('Marketing'));